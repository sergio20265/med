...
export class AboutComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seo.updateSeoData({
      title: 'О стационаре Новая Медицина | 15 лет опыта',
      description: 'Стационар в составе сети медицинских центров. 15 лет работы, лицензия, официальный договор, медицинский контроль 24/7.',
