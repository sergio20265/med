...
export const environment = {
  ...
  // ─── Email уведомления ─────────────────────────────────────────────────────
  // Получить бесплатный ключ: https://web3forms.com → введите psergio48@gmail.com
  // После подтверждения email вставьте сюда полученный access_key
  web3formsKey: '', // ← сюда вставить ключ с web3forms.com
